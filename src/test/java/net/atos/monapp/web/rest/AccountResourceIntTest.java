package net.atos.monapp.web.rest;

import net.atos.monapp.MonAppApp;
import net.atos.monapp.domain.Authority;
import net.atos.monapp.domain.User;
import net.atos.monapp.repository.AuthorityRepository;
import net.atos.monapp.repository.UserRepository;
import net.atos.monapp.security.AuthoritiesConstants;
import net.atos.monapp.service.MailService;
import net.atos.monapp.service.UserService;
import net.atos.monapp.service.dto.UserDTO;
import net.atos.monapp.web.rest.vm.KeyAndPasswordVM;
import net.atos.monapp.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MonAppApp.class)
